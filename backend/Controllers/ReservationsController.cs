...
public class ReservationsController : ControllerBase
{
    ...
    {
        var (reservation, error) =
            await _reservationsService.CreateReservation(body.UserId, body.DeskId, body.DateFrom, body.DateTo);
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
    public async Task<IActionResult> DeleteReservation([FromQuery] int userId, [FromRoute] int reservationId,
        [FromQuery] bool todayOnly)
    {
