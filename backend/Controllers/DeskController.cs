...
public class DeskController: ControllerBase
{
  ...
  public async Task<ActionResult<IEnumerable<GetDeskDto>>> GetDesksAndReservations ([FromQuery] int userId, [FromQuery] DateOnly rangeFrom, [FromQuery] DateOnly rangeTo)
  {
